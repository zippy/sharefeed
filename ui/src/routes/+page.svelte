<script lang="ts">
  import { FeedList, AccessibilityPanel } from '$lib/components';
...
<svelte:head>
  ...
  <meta name="description" content="Share links with your family and friends" />
</svelte:head>
...
<div class="page" class:high-contrast={highContrast}>
  ...
  <AccessibilityPanel bind:open={showSettings} onClose={() => showSettings = false} />
</div>
